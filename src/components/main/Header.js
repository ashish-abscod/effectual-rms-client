    ...
    <>
      <nav className="navbar navbar-expand-lg fixed-top text-white theme-bg">
        <div className="container-fluid">
          <a className="navbar-brand" href="/main"><b>Effectual RMS</b></a>
          ...
          <div className="collapse navbar-collapse ms-lg-5" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item">
                <a className="nav-link active me-2" aria-current="page" href="/main"><i className="bi bi-house-door me-1"></i>Home</a>
              </li>
              <li className="nav-item">
                <a className="nav-link me-2" href="/main"><i className="bi bi-activity me-1"></i>Activites</a>
              </li>
              { projectSelected ?
              <li className="nav-item">
                <Link to={'/comment'} className="nav-link me-2"><i className="bi bi-chat-dots me-1"/>Comment</Link>
              </li> : ""
              }
              <li className="nav-item d-lg-none">
                <a className="nav-link" href="/#"><i className="bi bi-key me-1"></i>Password</a>
              </li>
              <li className="nav-item d-lg-none">
                <a className="nav-link" href="/#" tabIndex="-1"><i className="bi bi-box-arrow-left me-1"></i>Sign Out</a>
              </li>
            </ul>
