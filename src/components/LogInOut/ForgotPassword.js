                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header theme2-bg justify-content-center">
                            <h5 className="modal-title theme3-color fw-bold fs-3 text-white" id="forgotPassLabel">Forgot Password</h5>
                        </div>
                        <div className="modal-body px-4">
                            ...
                            <form id="forgotPassword" className="text-center" name="login-form">
                                ...
                                <input type="text" id="userId" className="form-control fs-5 text-secondary" name="username" />
