                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6 d-flex flex-column justify-content-center">
                            <h1 className='theme2-color fw-bold mb-4'>Report Management System</h1>
                            <h3 className='theme3-color'>Effectual’s Report management system centrally manages all type of client projects along with the repository of search reports and communication. </h3>
                            <div>
